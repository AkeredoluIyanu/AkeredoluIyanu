...
house_df = pd.read_csv('houseing sale.csv')

st.title('Pandas Profiling of House sale Dataset')
house_profile = ProfileReport(house_df, explorative=True)
st_profile_report(house_profile)
